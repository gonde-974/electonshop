        ...
        <div className="relative w-full flex flex-col items-start p-4">
            ...
            {isCategoryVisible && (
                <div className="absolute top-0 left-0 w-full bg-white shadow-lg p-4 rounded-lg z-50">
                    ...
                    {/* Хоризонтална табела за категории на поголеми екрани */}
                    <div className="hidden sm:block mt-4">
                        <table className="min-w-full table-auto text-center">
                            <thead>
                                <tr className="bg-gray-100 text-gray-700">
                                    <th className="px-6 py-4 font-semibold">Категорија</th>
                                    <th className="px-6 py-4 font-semibold">Акција</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                                    {category.map((cat, index) => (
                                        <td key={index} className="px-6 py-4 border-b hover:bg-gray-50">
                                            <Link
                                                to={`/category/${cat.id}`}

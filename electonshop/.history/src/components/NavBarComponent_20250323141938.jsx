...
function NavBarComponent() {
  ...
  return (
    <>
      ...
      <div className="bg-gray-100 shadow-lg rounded-2xl flex flex-wrap justify-center gap-4 md:justify-between transition-all duration-300 hover:shadow-xl hover:bg-gray-200">
  <CategoryComponents />
</div> 
    </>
  );

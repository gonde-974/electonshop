...
function NavBarComponent() {
  ...
  <li className="flex items-center gap-2">
    <CiUser size={24} />
    <NavLink to="/" className="text-sm font-medium transition hover:text-mainYellow">
      Sign in
    </NavLink>
  </li>
  <li className="flex items-center gap-2">
    <div className="relative inline-block">
      <CiHeart size={24} />
      <span className="absolute top-0 right-0 transform translate-x-1/2 -translate-y-1/2 text-xs bg-mainRed text-white px-1 rounded-full">
        0
      </span>
    </div>
    <NavLink to="/" className="text-sm font-medium transition hover:text-mainYellow">
  ...
  <li className="flex items-center gap-2">
    ...
    <NavLink to="/cart" className="text-sm font-medium transition hover:text-mainYellow">
      Cart
    </NavLink>
  </li>
</ul>

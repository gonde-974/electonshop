...
function CategoryComponents({ menuCategoryOpen, setMenuCategoryOpen }) {
    ...
    return (
        <div className="relative w-full flex flex-col items-start p-4">
            ...
            >
                {menuCategoryOpen ? "Сокриј категориите" : "Прикажи категории"}
            </button>
    ...
    <div className="absolute top-0 left-0 w-full bg-white shadow-lg p-4 rounded-lg z-50">
        ...
        <div className="flex flex-wrap justify-center gap-4 mt-4">
            {/* Пробајте да ставите статичен текст за да проверите дали категориите се прикажуваат */}
            {category.length === 0 ? (
                <p>Нема категории</p>
            ) : (

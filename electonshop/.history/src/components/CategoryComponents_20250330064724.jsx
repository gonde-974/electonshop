        ...
        <div className="relative w-full flex flex-col items-start p-4">
            ...
            {isCategoryVisible && (
                <div className="absolute top-0 left-0 w-full bg-white shadow-lg p-4 rounded-lg z-50">
                    ...
                    <div className="container mx-auto flex items-center justify-center  p-6 rounded-2xl shadow-2xl border border-yellow-500">
                        <FaShopify className="text-green-700 w-[400px] h-[400px] animate-bounce" />
                    </div>

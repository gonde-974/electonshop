        ...
        <div className="relative p-4 flex flex-col items-center">
            ...
            {!menuOpen && (
                <button
                    ...
                    className="flex  px-4 py-2 bg-mainBlue text-whiteTextColor rounded-lg shadow-md transition-all duration-300 hover:bg-mainYellow"
                >
            ...
            {menuOpen && (
                <div className="absolute mx-auto mt-2 w-full max-w-5xl bg-white border border-gray-300 rounded-lg shadow-lg p-3 animate-slideDown flex flex-col items-center">

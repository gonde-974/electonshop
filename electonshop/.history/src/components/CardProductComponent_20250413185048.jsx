...
function CardProductComponent({ product, activeView }) {
  ...
  return (
    <div
      className={`product-card w-full md:w-4/5 p-4 rounded-xl bg-white shadow-md transition-all duration-300 
    ...
    >
      ...
      {/* Детали */}
      <div className={`${isListView ? 'flex flex-row items-center gap-4 w-full' : 'text-center w-full'}`}>

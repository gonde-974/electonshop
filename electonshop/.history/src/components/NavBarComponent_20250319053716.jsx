...
function NavBarComponent() {
  ...
  return (
    ...
    <nav className="navbar">
      ...
      <div className="flex items-center bg-white border border-gray-300 rounded-full shadow-md p-2 max-w-md w-full">
  <input 
    type="text" 
    placeholder="Search Product" 
    className="flex-grow px-4 py-2 text-blackTextColor placeholder-gray-500 outline-none bg-transparent"
  />
  <button className="bg-mainBlue text-whiteTextColor px-4 py-2 rounded-full hover:bg-mainYellow transition-all">
    Search
  </button>
</div>

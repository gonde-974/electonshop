...
function CartItemComponent({ item, onIncrease, onDecrease, onRemove }) {
  return (
    <div className="w-full max-w-5xl mx-auto bg-white/80 dark:bg-gray-900/80 backdrop-blur-lg shadow-xl rounded-2xl border border-gray-300 dark:border-gray-700 transition-all hover:shadow-2xl">

     

      {/* Product Row */}
      <div className="grid grid-cols-[1fr_1fr_1fr_1fr_60px] items-center gap-4 p-4 border-b border-gray-300 dark:border-gray-700 wi[100%]">

...
function CartItemComponent({ item, onIncrease, onDecrease, onRemove }) {
  return (
    <div className="w-full  mx-auto bg-white/80 dark:bg-gray-900/80 backdrop-blur-lg shadow-xl border border-gray-300 dark:border-gray-700 transition-all hover:shadow-2xl">
  ...
  src={item.thumbnail}
  alt={item.title}
  className="hidden md:block w-16 h-16 md:w-20 md:h-20 object-cover rounded-lg shadow-md border border-gray-200 dark:border-gray-700"
/>

    ...
    <>
      ...
      <nav className="bg-mainBlue text-whiteTextColor shadow-md">
        <div className="container mx-auto flex items-center justify-between p-4">
          ...
          <div className="flex flex-grow mx-4 items-center border border-mainYellow rounded-lg overflow-hidden">
            <input type="text" placeholder="Search Product" className="p-2 w-[30%] focus:outline-none text-blackTextColor" />

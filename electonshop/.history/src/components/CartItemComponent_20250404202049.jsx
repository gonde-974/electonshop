...
function CartItemComponent({ item, onIncrease, onDecrease, onRemove }) {
  return (
    <div className="w-full max-w-4xl mx-auto bg-white/70 dark:bg-gray-900/80 backdrop-blur-lg shadow-xl rounded-2xl border border-gray-300 dark:border-gray-700 transition-all hover:shadow-2xl">

      {/* Header */}
      <div className="grid grid-cols-4 bg-blue-500 text-white font-semibold text-center py-3 rounded-t-2xl">
        <p>Продукт</p>
        <p>Цена</p>
        <p>Количина</p>
        <p>Вкупно</p>

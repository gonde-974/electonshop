        ...
        <div className="relative w-full flex flex-col items-center">
            ...
            {!menuOpen && (
                <button
                    ...
                    className="fixed top-5 left-1/2 transform -translate-x-1/2 px-6 py-3 bg-mainBlue text-whiteTextColor rounded-full shadow-md transition-all duration-300 hover:bg-mainYellow"
                >
                    Категории
                </button>
            )}
            ...
            {menuOpen && (
                <div className="absolute top-full left-0 w-full bg-white border border-gray-300 rounded-lg shadow-lg p-3 animate-slideDown flex flex-col items-center">
                    ...
                    <button
                        ...
                        className="self-end mb-2 px-3 py-1 bg-red-500 text-white rounded-full shadow-md transition-all duration-300 hover:bg-red-700"
                    >
                        <X className="w-6 h-6" />
                    </button>

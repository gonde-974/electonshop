      ...
      <nav className="bg-mainBlue text-whiteTextColor shadow-md">
        ...
        {isOpen && (
          <ul className="md:hidden bg-mainBlue text-whiteTextColor flex flex-col items-center py-4 gap-4">
            <li><NavLink to="/favorites" className="hover:text-mainYellow" onClick={() => setIsOpen(false)}>Favorite</NavLink></li>
            <li><NavLink to="/cartPage" className="hover:text-mainYellow" onClick={() => setIsOpen(false)}>Cart Page</NavLink></li>

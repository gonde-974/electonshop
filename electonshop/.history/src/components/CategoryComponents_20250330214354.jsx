...
function CategoryComponents() {
    ...
    return (
        <div className="relative w-full flex flex-col items-start p-4">
            ...
            <button
                onClick={() => setIsCategoryVisible(!isCategoryVisible)} // Превртување на видливоста
            ...
            >
                {isCategoryVisible ? "Скриј категории" : "Прикажи категории"}
            </button>
            ...
            {isCategoryVisible && (
                <div
                    ...
                    style={{ zIndex: "999", position: "absolute" }} // Ensure overlay appears above other content
                >
                    <button
                        onClick={() => setIsCategoryVisible(false)} // Скривање на категориите
                    >
                        <X className="w-6 h-6" />
                    </button>

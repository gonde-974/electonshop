...
function CategoryComponents() {
    ...
    return (
        <div className="relative p-4">
            ...
            {/* DROP-DOWN МЕНИ */}
            {menuOpen && (
   <div className="absolute left-1/2 top-20 transform -translate-x-1/2 w-auto min-w-[50vh] max-w-[99vw] bg-white border border-gray-300 rounded-lg shadow-lg animate-fadeIn p-3">
   <ul className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:flex lg:justify-start lg:overflow-x-auto lg:whitespace-nowrap lg:gap-3 scrollbar-hide">

  ...
  return (
    <div className="relative bg-white rounded-xl shadow-lg p-4 transition-transform duration-300 hover:scale-105 hover:shadow-xl w-full sm:w-80 group">
        ...
        <div className="relative">
            ...
            <div className="absolute inset-0 bg-greey bg-opacity-50 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center text-white text-lg font-semibold rounded-lg">

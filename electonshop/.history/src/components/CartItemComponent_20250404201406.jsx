  ...
  return (
    <div className="flex flex-col md:flex-row items-center justify-between gap-6 p-6 bg-white/80 dark:bg-gray-900/80 backdrop-blur-md shadow-lg rounded-2xl border border-gray-300 dark:border-gray-700 transition-all hover:scale-[1.02]">
      ...
      <div className="flex items-center gap-3 bg-gray-100 dark:bg-gray-800 px-4 py-2 rounded-xl shadow-md">
        <button className="text-lg font-bold px-3 py-1 bg-gray-200 dark:bg-gray-700 rounded-lg hover:bg-gray-300 dark:hover:bg-gray-600 transition">
          +
        </button>
      ...
      {/* Remove Button */}
      <button className="p-3 rounded-full bg-red-500/10 dark:bg-red-600/10 text-red-500 dark:text-red-400 hover:bg-red-500/20 hover:text-red-600 dark:hover:bg-red-600/20 dark:hover:text-red-500 transition">
        <RxCross2 size={22} />
      </button>
    </div>
  )

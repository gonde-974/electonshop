...
function CardProductComponent({ product }) {
  return (
    ...
    <span className="text-xl font-semibold text-red-500">{product.price}</span>
        ...
        {/* Overlay ефект */}
        <div className="absolute inset-0 bg-black bg-opacity-50 opacity-0  hover:opacity-100 transition-opacity duration-300 flex items-center justify-center text-white text-lg font-semibold rounded-lg pointer-events-none" />

...
function CategoryComponents({ setMenuCategoryOpen }) {
    ...
    const [isCategoryVisible, setIsCategoryVisible] = useState(false); // нова променлива за контрола на видливоста на категориите
    ...
    return (
        <div className="relative w-full flex flex-col items-start p-4">
            ...
            <button 
                onClick={() => {
                    setIsCategoryVisible(!isCategoryVisible); // Променување на видливоста
                    setMenuCategoryOpen(true); // Отварање на менито
                }} 
            ...
            >
                {isCategoryVisible ? "Сокриј категории" : "Прикажи категории"}
            </button>

...
function CardProductComponent({ product }) {
  return (
    <div className="bg-white rounded-xl shadow-lg p-4 transition-transform duration-300 hover:scale-105 hover:shadow-xl w-full sm:w-80">
        ...
        />
        <div className="absolute inset-0 bg-black bg-opacity-50 transition-opacity duration-300 hover:opacity-0 flex items-center justify-center text-white text-lg font-semibold rounded-t-lg"/>
        </div>

...
function NavBarComponent() {
  ...
  return (
    <>
      ...
      <div className="bg-white border border-gray-200 shadow-md rounded-2xl flex flex-wrap justify-center gap-4 md:justify-between p-5 transition-all duration-300 hover:shadow-lg hover:border-gray-300">
  <CategoryComponents />
</div>

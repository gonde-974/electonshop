        ...
        <div className="relative w-full flex flex-col items-start p-4">
            ...
            {menuOpen && (
                <div className="absolute top-full left-0 w-full bg-white border border-gray-300 rounded-lg shadow-lg p-3 animate-slideDown flex flex-col items-start">
                    ...
                    {/* ЛИСТА СО КАТЕГОРИИ */}
                    <div className="w-full flex flex-wrap gap-3 text-left bg-white border border-gray-200 shadow-md rounded-2xl flex flex-wrap justify-center gap-4 md:justify-between transition-all duration-300 hover:shadow-lg hover:border-gray-300">

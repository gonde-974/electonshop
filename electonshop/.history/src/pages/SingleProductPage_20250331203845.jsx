...
function SingleProductPage() {
  ...
  <span className="text-lg font-bold text-blackTextColor">Количина:</span>
  
  <button 
    onClick={() => setCounter(prev => Math.max(1, prev - 1))} 
    className="bg-mainBlue text-white px-5 py-3 rounded-xl text-lg font-semibold shadow-md hover:bg-mainYellow transition"
  >
    -
  </button>

  <span className="text-xl font-bold px-6 py-2 bg-lightBlueColor rounded-xl shadow-inner">
    {counter}
  </span>

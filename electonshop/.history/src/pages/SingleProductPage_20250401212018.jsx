    ...
    <div className="max-w-6xl mx-auto p-6 bg-white shadow-lg rounded-2xl border-4 border-gray-200  transition-all duration-300">
      <div className="flex flex-col md:flex-row gap-8">
        ...
        <div className="md:w-1/2 space-y-4 border-l-4 border-gray-200 pl-6">
          ...
          <NavLink to='/cart' className="w-[200px] bg-mainYellow text-white py-3 rounded-[30px] shadow-md border-4   hover:border-mainBlue transition-all flex items-center justify-center gap-2 cursor-pointer">
            <FaShoppingCart /> Add to cart
          </NavLink>
          <NavLink to='/favorite' className="bg-mainYellow text-white py-3 rounded-[30px] shadow-md border-4   hover:border-mainBlue transition-all flex items-center justify-center gap-2 cursor-pointer">
            <CiHeart />
          </NavLink>
        </div>
      </div>

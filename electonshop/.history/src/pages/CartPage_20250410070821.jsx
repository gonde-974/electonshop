          ...
          <div className='flex flex-col lg:flex-row gap-8'>
            ...
            <div className='w-full lg:w-2/5 bg-white p-6 rounded-xl shadow-xl h-fit border border-gray-100'>
              ...
              <div className='flex justify-between text-lg font-medium mb-6'>
                ...
                <span className='text-blue-600 font-bold'>{curentCoupon==='gonde' ? (totalPrice/2).toFixed(2) : totalPrice.toFixed(2)} ден.</span>
              </div>
              ...
              {/* Checkout button */}
              <button className='w-full bg-mainBlue text-white font-semibold py-3 rounded-md hover:bg-mainYellow transition'>
                Направи нарачка
              </button>
            </div>
          </div>

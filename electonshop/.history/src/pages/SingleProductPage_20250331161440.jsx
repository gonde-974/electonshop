...
function SingleProductPage() {
  ...
  return (
    <div className="w-full md:w-[600px] bg-white shadow-lg rounded-2xl overflow-hidden flex flex-col md:flex-row">
      {/* Лева страна - Слика */}
      ...
      <div className="w-full md:w-1/2 p-6 flex flex-col justify-between">
        ...
        <div className="mt-4 flex items-center justify-between">
          ...
          <button className="bg-mainYellow text-whiteTextColor px-4 py-2 flex items-center gap-2 hover:bg-yellow-600 rounded-lg">

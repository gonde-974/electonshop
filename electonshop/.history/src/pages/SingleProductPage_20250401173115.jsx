    ...
    <div className="single-product-container">
      ...
      <div className="product-details">
        <div>
          ...
          <p className="product-info">Категорија: <span className='font-semybold'>{product.category}</span></p>
        ...
        <div className="quantity-container">
          ...
          <span className='single-product-total-price'>Вкупно :{product.price}</span>
        </div>

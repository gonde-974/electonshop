...
function Homepage() {
    ...
    const[activeView, setActiveView] = useState('LestActive')
    ...
    return (
      ...
      <div className="flex gap-2 bg-white rounded-xl shadow-sm p-2 border border-gray-100">
        ...
        {/* Grid Icon */}
        <div className="p-2 md:p-3 rounded-md cursor-pointer hover:bg-gray-100 text-mainBlue hover:text-blue-600 transition-colors duration-200">
                ...
                <div className="product-grid">
                    {allProduct.map((product, index) => (
                        <div key={product.id || index} className="product-card">
                           <CardProductComponent product={product} activeView={activeView} />

    ...
    <div className="bg-white rounded-2xl shadow-xl flex flex-col md:flex-row overflow-hidden max-w-5xl mx-auto p-8 border border-gray-200">
      ...
      <div className="flex flex-col justify-between w-full md:w-1/2 pl-6">
        ...
        <div className="flex items-center mt-4">
          <button onClick={() => setCounter(prev => Math.max(1, prev - 1))} className="bg-mainBlue text-white px-4 py-2 rounded-lg">-</button>
        ...
        {/* Копче за купување */}
        <button className="mt-6 bg-gray-500 text-white px-6 py-3 rounded-lg shadow-lg hover:bg-yellow-500 transition flex items-center justify-center gap-2">

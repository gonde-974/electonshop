...
function SingleProductPage() {
  ...
  return (
    <div className="max-w-6xl mx-auto p-6 bg-white shadow-lg rounded-2xl border-2 border-gray-200  transition-all duration-300">
      <div className="flex flex-col md:flex-row gap-8">
            ...
            {product.images.map((el, index) => (
              <img
                ...
                className={`w-16 h-16 object-cover rounded-lg border-2 cursor-pointer transition-all duration-300 ${
                  index === currentImageIndex ? 'border-mainYellow shadow-md' : 'border-gray-300 opacity-75 hover:opacity-100 hover:border-blue-400'
                }`}
              />
            ))}
          </div>
        ...
        <div className="md:w-1/2 space-y-4 border-l-4 border-gray-200 pl-6">
          ...
          <button className="w-[200px] bg-mainYellow text-white py-3 rounded-[30px] shadow-md border-4 hover:bg-blue-700 hover: transition-all flex items-center justify-center gap-2">
